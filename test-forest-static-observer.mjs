...
import { createForestGPU, commitHookOwners } from './forest-gpu.js';
...
function commitsFor(r, forestX, tag) {
  ...
  const ro2 = makeRenderObject(other, b, tag + '2');   // one material, one observer
...
function invalidatedThenSkips(r, forestX, ro, ro2) {
  forestX.invalidateStaticRefresh();
  const f = frame(r);
