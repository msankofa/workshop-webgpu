...
STATUS 2026-08-23: W1 shipped (sea level descriptor field + protocol + facade + server + wave keys; `test-base-game-sea-level.mjs`). Next W2. Follows the terrain plan
