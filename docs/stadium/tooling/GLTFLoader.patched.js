	...
	*/
	...
	class GLTFParser {
		...
		constructor( json = {}, options = {} ) {
			...
			if ( false ) { // patched: ImageBitmapLoader fetch()es blob: URLs, blocked in sandboxed viewers
		...
		loadTextureImage( textureIndex, source, loader ) {
			...
			if ( source.bufferView !== undefined ) {
				...
				sourceURI = parser.getDependency( 'bufferView', source.bufferView ).then( function ( bufferView ) {
					...
					// patched: data: URI instead of a blob object URL — sandboxed
					// viewers block blob: loads but generally allow data: images
					...
					sourceURI = 'data:' + source.mimeType + ';base64,' + btoa( bin );
					return sourceURI;
