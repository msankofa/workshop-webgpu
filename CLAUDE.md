...
| Roads | `roads.md` | `roads.js`, `road-network.js`, `road-index.js`, `road-mesh.js`, `road-path.js`, `trail-router.js`, `base-game-plan.js`, `base-game-sites.js`, `base-game-trails.js` (wired into `bot-viewer-v3.html` and `base-game.html`) |
